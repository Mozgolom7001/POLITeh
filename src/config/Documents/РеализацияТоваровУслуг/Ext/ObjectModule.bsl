...
Функция ПечатьТОРГ12(БезУслуг = Ложь)
		...
		//ВЦ+
		ОбластьМакета.Параметры.ДолжностьРуководителя = "Менеджер";
		...
		//ВЦ+
		ОбластьМакета.Параметры.ДолжностьКладовщика = "Менеджер";
		//ВЦ-
		// Доверенность
...
//ВЦ+
	ЭтоСобственныйКонтрагент = ЭтоСобственныйКонтрагент(Контрагент);
	Если не ЭтоСобственныйКонтрагент Тогда
//ВЦ-
...
Процедура ДвиженияПоРегистрамУпр(РежимПроведения, СтруктураШапкиДокумента, 
	...
	Если ОтражатьВУправленческомУчете Тогда
		...
		Если ВидПередачи = Перечисления.ВидыПередачиТоваров.СоСклада и //ВЦ+
			Не ЭтоСобственныйКонтрагент Тогда
			//ВЦ-
...
КонецФункции // ЭтоСобственныйКонтрагент()  //ВЦ-
