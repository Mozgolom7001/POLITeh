...
Процедура ПроверкаПериодаЗаписейРегистров(НаборЗаписей, Отказ)
	...
	//ВЦ+
	// Снимаем проверку на регламентированную дату запрета редактирования документов связанных 
	//с регистром накопления РасчетыСКонтрагентами, ЗаказПокупателя
	
	Если МетаданныеНабора.Имя = "РасчетыСКонтрагентами" Тогда
